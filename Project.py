...
def caleasymarks():
    ...
    con = sqlite3.connect("Aashu.db")
    c = con.cursor()
   # c.execute("Create table marks ( Name varchar(80), Reg_No number, Section varchar(80), Category varchar(80), Q1 int, Q2 int, Q3 int, Q4 int, Q5 int, Q6 int, Q7 int, Q8 int, Q9 int, Q10 int, Marks int );")
